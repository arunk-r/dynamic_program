...
fun main() {
    println(BinarySearch().search(intArrayOf(2,5), 5))
    println(BinarySearch().search(intArrayOf(-1,0,3,5,9,12), 2))
    println(BinarySearch().search(intArrayOf(-1,0,3,5,9,12), 9))
}