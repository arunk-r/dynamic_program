 ...
 */
class FindingPairsWithACertainSum(val nums1: IntArray, val nums2: IntArray) {
...
fun main() {
    val t = FindingPairsWithACertainSum(intArrayOf(1,1,2,2,2,3), intArrayOf(1,4,5,2,5,4))
    println(t.count(7))
    t.add(3,2)
    println(t.count(8))
}
