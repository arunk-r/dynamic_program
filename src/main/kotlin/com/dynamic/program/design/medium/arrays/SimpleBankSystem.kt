...
class SimpleBankSystem(private val balance: LongArray) {
    ...
    fun transfer(a1: Int, a2: Int, money: Long): Boolean {
        if(a1-1 in balance.indices && a2-1 in balance.indices) {
 ...
 * var obj = SimpleBankSystem(balance)
