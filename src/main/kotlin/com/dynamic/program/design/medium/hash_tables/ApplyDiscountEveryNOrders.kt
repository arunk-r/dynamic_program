 ...
 */
class ApplyDiscountEveryNOrders(val n: Int, private val discount: Int, private val products: IntArray, private val prices: IntArray) {
 ...
 * var obj = ApplyDiscountEveryNOrders(n, discount, products, prices)
