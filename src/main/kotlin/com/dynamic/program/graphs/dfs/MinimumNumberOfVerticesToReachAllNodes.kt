...
fun main() {
    println(MinimumNumberOfVerticesToReachAllNodes().findSmallestSetOfVertices(6, listOf(listOf(0,1),listOf(0,2),listOf(2,5),listOf(3,4),listOf(4,2))))
}