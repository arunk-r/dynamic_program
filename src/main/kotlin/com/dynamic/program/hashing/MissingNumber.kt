 ...
 * x ^ y = y ^ x
 */
fun missingNumberBitWise(nums: IntArray): Int {
...
fun main() {
    ...
    println(missingNumberBitWise(intArrayOf(3,0,1)))
    println(missingNumberBitWise(intArrayOf(0,1)))
    println(missingNumberBitWise(intArrayOf(9,6,4,2,3,5,7,0,1)))
